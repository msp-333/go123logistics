...
export default function AboutPage() {
  ...
  return (
    <article className="py-10 sm:py-12 lg:py-14 bg-white">
      {/* ---------- HERO (no image background, dark text) ---------- */}
      ...
      {/* ---------- CTA (dark image background like home hero) ---------- */}
      <section className={shell} aria-labelledby="cta-title">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 shadow-soft">
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${publicPath("/images/hero.png")})`,
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          />
          {/* Overlay (same vibe as home hero) */}
          <div
            aria-hidden
            className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,17,15,0.92),rgba(0,17,15,0.75),rgba(0,17,15,0.35))]"
          />
          {/* Subtle grid */}
          <div
            aria-hidden
