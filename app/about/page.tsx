  ...
  return (
    <article className="bg-white">
      ...
      <section aria-labelledby="about-hero" className="relative overflow-hidden">
        ...
        {/* Overlay for readability + brand vibe (uses your existing brand dark feel) */}
        <div
          aria-hidden
          className="absolute inset-0
            bg-[linear-gradient(to_right,rgba(0,17,15,0.92),rgba(0,17,15,0.78),rgba(0,17,15,0.35),rgba(0,17,15,0.10))]
          "
        />

        {/* Subtle grid texture (matches your home hero style) */}
        <div
          aria-hidden="true"
          ...
          <div className={shell}>
            <div className="py-14 sm:py-16 lg:py-20">
              <div className="max-w-2xl text-center md:text-left">
                ...
                <p className="mt-5 text-white/75 text-[15px] sm:text-base leading-6 sm:leading-7">
                ...
                <ul className="mt-6 flex flex-wrap justify-center md:justify-start gap-2">
                  {["Honest pricing", "Proactive updates", "Protected freight"].map((label) => (
                    <li
                      key={label}
                      className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-[13px] font-semibold text-white/85 ring-1 ring-white/15 backdrop-blur"
                    >
                      <svg
                ...
                <div className="mt-7 flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                  ...
                  <Link
                    href="/shipping-guide"
                    className="inline-flex items-center justify-center rounded-lg bg-white/10 px-6 py-3 font-semibold text-white ring-1 ring-white/15 hover:bg-white/15 shadow-soft"
                  >
                    Shipping Guide
                  </Link>
                </div>
      ...
      {/* keep spacing similar to other pages */}
